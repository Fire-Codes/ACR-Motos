...
@Component({
  selector: 'app-seleccionar-producto-descuento',
  templateUrl: './seleccionar-producto-descuento.component.html',
  styleUrls: ['./seleccionar-producto-descuento.component.scss']
})
export class SeleccionarProductoDescuentoComponent implements OnInit {
  ...
  cerrarModal() {
    this.cerrarModalSeleccionarProductosDescuento.emit();
  }
